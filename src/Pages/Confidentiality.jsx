function Confidentiality() {
  return (
    <div className="container mx-auto w-2/3 my-5 p-8 border shadow-md">
      ...
      <p>
        Le site web Lache ta loc est détenu par Lache ta loc, qui est un
        contrôleur de données de vos données personnelles.
      </p>

      <p>
        Nous avons adopté cette politique de confidentialité, qui détermine la
        manière dont nous traitons les informations collectées par Lache ta loc,
      ...
      <p>
        Lorsque vous visitez le Lache ta loc, nous recueillons automatiquement
      ...
      <p>
        ...
        <a
          href="mailto:contact@laurenthugo.com"
          className="text-blue-500 underline"
        >
          contact@laurenthugo.com
        </a>
        .
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-3">Vos droits :</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-3">Divulgation légale :</h2>
